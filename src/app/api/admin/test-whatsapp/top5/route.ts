...
export async function POST(req: Request) {
  try {
    ...
    try {
      ...
      return NextResponse.json({ success: true, mode: "top5", deliveryLogId: log.id, messageId, itemsSentCount: digest.itemIds.length, template: "pulse_digest_ready" });
    ...
    console.error("Admin top5 test delivery failed:", error);
